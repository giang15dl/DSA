...
const int MAX_HASH = 10000;
const int MAX_TANK = 30;
...
public:
    ...
    int buildAndPourOut(int len, int tank[], int water) {
        ...
        int max = 0;
        for (int i = 0; i < hash[value]; i++) {
            int index = locations[value][i];
...
private:
    ...
    int *height;
    int hash[MAX_HASH];
    int locations[MAX_HASH][MAX_TANK];
